    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-16" style={{ minHeight: 'calc(100vh - 4rem)' }}>
      <div className="text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-pink-500 to-rose-600 bg-clip-text text-transparent mb-4" style={{ lineHeight: '1.1' }}>
            Coming Soon
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Handcrafted</h3>
              <p className="text-slate-600">Beautifully crafted braided accessories</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Unique Styles</h3>
              <p className="text-slate-600">One-of-a-kind designs for every occasion</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg">
              ...
              <p className="text-slate-600">Crafted with passion and attention to detail</p>
            </div>
          </div>
